...
export function CtaForm() {
  ...
  return (
    ...
    >
      <label htmlFor="email" className="text-[13px] text-on-dark-body">
        Work email
      </label>
      <input
        id="email"
        ...
        disabled={busy}
        className="h-[50px] rounded-md border border-navy-line bg-navy-deep px-4 font-sans text-[15px] text-cta-fg placeholder:text-on-dark-hint focus:border-accent focus:outline-none disabled:opacity-70"
      />
